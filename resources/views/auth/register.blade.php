...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"> <h4 style="text-align:center;"><b>{{ __('Register') }}</b></h4></div>
                    ...
                    <form method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn" style="border-radius:0;background:#245e71;color:white;">
                                    <b> {{ __('Register') }}</b>
                                </button>
                            </div>
                        </div>
